...
| WR-006 | P2 | Integrate notes with personal reading-notes folder | User placed reading-notes under `personal/projects` as a side project. | Improve export naming to `reading-notes_YYYY-MM-DD-title.md`; add helper/import workflow for `~/workspace/reading-notes` later. | Verify |
